...
class PermanentEmployee(Employee):
    def __init__(self,name,id_number,dob,gender,salary):
        super().__init__(name,id_number,dob,gender)# instead of repeating the inherited elements use the keyword super
        self.salary=salary
...
p2 =TemporaryEmployee(name="mary",id_number="40815213",dob="2003-04-29",gender="female",hourly_pay=10000,end_date="2024-03-27")
p2.print_details()
p2.print_hourly_pay()
p2.print_end_date()